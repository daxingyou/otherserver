...
bool BuffFactory::loadFightBuff()
{
	...
	cout << "iRecordCount:" << iRecordCount << endl;
	for(int i = 0; i < iRecordCount; i++)
	{
		...
		/*cout << "pNewBuff->m_iBuffID:" << pNewBuff->m_iBuffID << " pNewBuff->m_strBuffName:" << pNewBuff->m_strBuffName
			<< " pNewBuff->m_iBuffGroupID:" << pNewBuff->m_iBuffGroupID << " pNewBuff->m_iBuffType:" << pNewBuff->m_iBuffType
			<< " pNewBuff->m_dwLifeRound:" << pNewBuff->m_dwLifeRound << " pNewBuff->m_bPostAttackCount:" << pNewBuff->m_bPostAttackCount
			<< " pNewBuff->m_iMaxOverlapCount:" << pNewBuff->m_iMaxOverlapCount << " pNewBuff->m_iRoundInteval:" << pNewBuff->m_iRoundInteval << endl;*/
		...
		///cout << "pNewBuff->m_iBuffID:" << pNewBuff->m_iBuffID << endl;
