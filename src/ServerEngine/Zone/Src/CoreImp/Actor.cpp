...
bool Actor::createEntity(const std::string& strData)
{
	...
	printf("Actor::createEntity------when sendtoClientInfo------------");
	sendToClientInfo();
...
void Actor::changeProperty(PropertySet::PropertyKey iKey, int iChgValue, int iReason)
{
	...
	printf("Actor::changeProperty---------Entity::changeProperty front---------");
	Entity::changeProperty(iKey, iChgValue, iReason);
	printf("Actor::changeProperty---------Entity::changeProperty end---------");
}
...
{
	printf("Actor::sendToClientInfo-------send actor-----\n");
	// 发送GetRole下行
	{
		...
		printf("Actor::sendToClientInfo-------when start end role to client-----\n");
		sendMessage(pkg);
		printf("Actor::sendToClientInfo-------send role end-----\n");
	}
