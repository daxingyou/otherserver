...
void protobuf_AssignDesc_RouterServer_2eproto() {
  ...
  CS_RS_ALogin_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(CS_RS_ALogin));
  RouterServerCMD_descriptor_ = file->enum_type(0);
  RSAuthCode_descriptor_ = file->enum_type(1);
}
...
void protobuf_AddDesc_RouterServer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "strTransMsg\030\002 \002(\t*m\n\017RouterServerCMD\022\023\n\016"
    "RS_ROUTER_AUTH\020\350\007\022\030\n\023RS_ROUTER_WORLDLIST"
    "\020\351\007\022\025\n\020RS_ROUTER_ALOGIN\020\352\007\022\024\n\017RS_ROUTER_"
    "ERROR\020\353\007*0\n\nRSAuthCode\022\016\n\nRS_AUTU_OK\020\000\022\022"
    "\n\016RS_AUTU_PASSWD\020\001", 658);
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_strTransMsg:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->strtransmsg().data(), this->strtransmsg().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
