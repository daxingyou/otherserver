...
public:
    ...
    {
    	FDLOG("verifyUserLoginCallback")<<"onClose=|verifyUserLoginCallback"<<endl;
		//ServerEngine::LJSDK::async_response_verifyUserLogin(m_current,ServerEngine::en_INVALIDLOGIN);
    }
...
public:
	...
	virtual void onClose()
	{
		FDLOG("verifyUserLoginCallback")<<"onClose=|"<<endl;
		//ServerEngine::LJSDK::async_response_verifyUserLogin(m_current,ServerEngine::en_INVALIDLOGIN);
	}
...
public:
    ...
    virtual void onClose()
    {
		FDLOG("PhoneStreamCallback")<<"onClose=|PhoneStreamCallback"<<endl;
    }
