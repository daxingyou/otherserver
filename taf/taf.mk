...
HCE2CPP      = ${Project_PATH}/tool/taf/taf/bin/hce2cpp
JCE2CPP      = ${Project_PATH}/tool/taf/taf/bin/jce2cpp

#----------------------------------------------------------------------------------

INCLUDE     += -I${Project_PATH}/tool//taf/taf/include
LIB_DIR     += -L${Project_PATH}/tool/taf/taf/lib64
LIB         += -lhessian -lutil
